...
type dhcpd struct {
	...
	IfconfigScriptFileLocation string `goconf:"dhcpd:dhcpd_ifconfig_file_location"`     // IfconfigScriptFileLocation : Ifconfig scripts file location for internal interfaces
